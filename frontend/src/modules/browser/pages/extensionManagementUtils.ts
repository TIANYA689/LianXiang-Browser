...
export const EXTENSION_HISTORY_STORAGE_KEY = 'lianxiang-browser.extensionManagement.history.v1'
export const EXTENSION_DOWNLOAD_PROXY_STORAGE_KEY = 'lianxiang-browser.extensionManagement.downloadProxy.v1'
