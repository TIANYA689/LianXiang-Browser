---
name: lianxiang-browser-openclaw-automation-plan
description: Use when implementing, reviewing, auditing, or updating the lianxiang-browser and OpenClaw integration design, rollout status, or public HTTP API contract. Prefer this skill for low-coupling integration work around runtime/session, runtime/stop, automation/scripts, playwright-cdp execution, and OpenClaw compatibility mapping. Do not use it for day-to-day LaunchServer API invocation; use the sibling lianxiang-browser-openclaw skill instead.
---

# 链享浏览器 OpenClaw Integration Plan
...
If the task is operational usage of LaunchServer from OpenClaw, read the sibling skill at `../lianxiang-browser-openclaw/SKILL.md` instead.
...
1. Keep OpenClaw as the orchestration layer and 链享浏览器 as the execution layer.
