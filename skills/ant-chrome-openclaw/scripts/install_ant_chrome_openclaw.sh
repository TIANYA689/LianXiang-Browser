...
Options:
  ...
  --browser-profile NAME     Browser profile name to create/update (default: lianxiang-browser)
  --base-url URL             链享浏览器 LaunchServer base URL
...
skill_name="lianxiang-browser-openclaw"
...
env_map["LIANXIANG_BROWSER_BASE_URL"] = base_url
env_map["LIANXIANG_BROWSER_API_HEADER"] = api_header
if api_key.strip():
