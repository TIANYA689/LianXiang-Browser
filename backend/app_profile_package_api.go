...
const profilePackageFormat = "lianxiang-browser-profile-package"
...
func (a *App) BrowserProfilePackageExport(profileIds []string) (ProfilePackageExportResult, error) {
	...
	defaultName := fmt.Sprintf("lianxiang-browser-profile-package-%s.zip", time.Now().Format("20060102-150405"))
