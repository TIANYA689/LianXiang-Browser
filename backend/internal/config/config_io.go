...
const EnvLaunchServerAPIKey = "LIANXIANG_BROWSER_API_KEY"
...
func ApplyEnvironmentOverrides(config *Config) {
	...
	if apiKey := strings.TrimSpace(os.Getenv(EnvLaunchServerAPIKey)); apiKey != "" {
		config.LaunchServer.Auth.APIKey = apiKey
	}
}
