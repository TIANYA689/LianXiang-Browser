...
This document defines the macOS packaging plan for 链享浏览器.
...
- writable state is redirected to `~/Library/Application Support/lianxiang-browser`
...
- `链享浏览器.app/Contents/MacOS/bin`
- `链享浏览器.app/Contents/MacOS/config.yaml`
- `链享浏览器.app/Contents/MacOS/chrome/README.md`
...
- `链享浏览器.app/Contents/MacOS/lianxiang-browser`
- `链享浏览器.app/Contents/Resources/bin/xray`
- `链享浏览器.app/Contents/Resources/bin/sing-box`
...
- `~/Library/Application Support/lianxiang-browser`
...
- first launch creates `~/Library/Application Support/lianxiang-browser`
...
- detached writable state under `~/Library/Application Support/lianxiang-browser`
