...
try {
    ...
    $builderImage = "lianxiang-browser-linux-builder:local"
    ...
    $npmCacheVolume = "lianxiang-browser-linux-npm-cache"
    $nodeModulesVolume = "lianxiang-browser-linux-node-modules-$linuxArch"
    $goModCacheVolume = "lianxiang-browser-linux-go-mod-cache"
    $goBuildCacheVolume = "lianxiang-browser-linux-go-build-cache"
